            ...
            <div className="flow-grid checkout-grid">
              <div className="flow-main">
                <form className="panel checkout-panel" onSubmit={submitOrder}>
                  ...
                  <div className="demo-warning pix-security-note"><img src="/assets/pix-security-badge.png" alt="" className="pix-security-badge" /><div><strong>PIX seguro</strong><span>A cobrança é gerada somente após a validação de segurança.</span></div></div>{isEmptyPreview ? <div className="demo-validation-hint"><Info size={16} /> Validação QA: o botão de geração PIX deve rejeitar dados incompletos e assentos ausentes.</div> : null}
