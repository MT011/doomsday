...
describe("AmploPay credentials", () => {
  it("requires protected credentials, live PIX activation and a public callback origin", () => {
  ...
  it.skipIf(process.env.AMPLOPAY_RUN_EXTERNAL_CREDENTIAL_TEST !== "true")("validates the configured server credentials through the producer endpoint", async () => {
